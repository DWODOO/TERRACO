...
class ProductCategory(models.Model):
    ...
    )  # If this field is checked, the negative stock will be authorized for product that belongs to this category
...
class ProductTemplate(models.Model):
    ...
    )  # If this field is checked, the negative stock will be authorized for product that belongs to this template
