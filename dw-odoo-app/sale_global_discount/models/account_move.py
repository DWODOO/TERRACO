...
class AccountMove(models.Model):
    ...
    global_discount = fields.Monetary('Global Discount', compute="_compute_global_discount", store=1)
    amount_untaxed_with_discount = fields.Monetary('Montant Brut', compute="_compute_amount_untaxed_with_discount", readonly=1, store=1)
    ...
    def _compute_global_discount(self):
        for line in self.invoice_line_ids:
            self.global_discount += line.discount_amount
    ...
    def _compute_amount(self):
        #recompute amount_untaxed with global discount
        for move in self:
