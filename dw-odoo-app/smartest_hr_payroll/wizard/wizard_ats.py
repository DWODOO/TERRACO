...
class Wizardats(models.TransientModel):
    ...
    document_excel = fields.Binary(string="Document", readonly=True)
    document_pdf = fields.Binary(string="Document", readonly=True)
    ...
    def def_ats_excel(self):
        wb_obj = openpyxl.load_workbook('/home/odoo/repositories/smartest-odoo-app/smartest_hr_payroll/report/ats.xlsx')
        ...
        c100 = sheet_obj['F15']
        c100.value = self.id_emp.company_id.company_registry
        # c101 = sheet_obj['N13']
        # c101.value = self.id_emp.company_id.company_registry
        ...
        wb_obj.save("/home/odoo/extractions/ats.xlsx")
    ...
    def def_ats_pdf(self):
        ...
        fillpdfs.write_fillable_pdf(
            '/home/odoo/repositories/dz-payroll/smartest_hr_payroll/report/ats_verso_merged.pdf',
            '/home/odoo/extractions/ats_verso_merged.pdf',
            data_dict
        )
        ...
        file = open("/home/odoo/extractions/ats_verso_merged.pdf",
                    "rb")
        out = file.read()
        file.close()
        self.document_pdf = base64.b64encode(out)

    def init_ats_excel(self):
        self.def_ats_excel()
        file = open(
            "/home/odoo/extractions/ats.xlsx", "rb")
        out = file.read()
        file.close()
        self.document_excel = base64.b64encode(out)
        action = self.env.ref('smartest_hr_payroll.wizard_ats_action').read()[0]
